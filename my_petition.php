...
<head>
    ...
    <title>Petition Power | My Petitions</title>
    <!-- Favicon-->
...
<section class="py-5 border-bottom">
    <div class="container px-5 my-5 px-5">
        <div class="text-center mb-5">
            <h2 class="fw-bolder">Browse my petitions</h2>
            <p class="lead mb-0">Find all my petitions here</p>
        </div>
        <div class="row gx-5 justify-content-center">
            <div class="col-lg-12">
                <!-- Testimonial 1-->
                <?php
                $petitions = getMyPetitions(getSession("user_data")[0]);
                if (isset($petitions)) {
